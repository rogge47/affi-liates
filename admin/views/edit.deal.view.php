        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div>
              <table>
                <tr>
                  <td><p><b><?php echo _AUTHORBY; ?> </b> <a class="link-primary" href="../controller/edit_user.php?id=<?php echo $check_access['user_id']; ?>"><?php echo $deal['author_name']; ?></a></p></td>
                  <td><p><b><?php echo _PUBLISHED; ?> </b> <?php echo FormatDate($connect, $deal['deal_created']); ?></p></td>
                  <td><p><b><?php echo _UPDATED; ?> </b> <?php echo FormatDate($connect, $deal['deal_updated']); ?></p></td>
                </tr>
              </table>
            </div>
              ...
              <form enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
               ...
               <div class="form-row">
                  ...
                  <div class="block col-md-12">
                    ...
                    <div class="col-3">
                      ...
                      <div class="input-group">
                            ...
                            <input class="form-control" value="<?php echo $deal['deal_price']; ?>" name="deal_price" type="text">
                        </div>
                    </div>
                    ...
                    <label><?php echo _TABLEFIELDURLLINK; ?></label>
                    <input type="text" value="<?php echo $deal['deal_link']; ?>" name="deal_link" class="form-control">
                    ...
                    <label><?php echo _TABLEFIELDGALLERY; ?></label>
                      <div class="gallery">
                          <?php foreach($gallery as $item): ?>
                            <div class="image">
                            <div class="badge-container" style="background:url(../../images/<?php echo $item['picture']; ?>);">
                ...
                <div class="block col-md-12">
                  ...
                  <div class="new-image" id="image-preview" style="background: url(../../images/<?php echo $deal['deal_image'] ?>);">
                    ...
                    <input type="file" name="deal_image" id="image-upload" />
                  </div>
