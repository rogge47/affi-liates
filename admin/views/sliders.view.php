  ...
  $(document).ready(function(){
    $('#table_id').dataTable({
     ...
     "mRender" : function (data) {
      return "<img src='"+IMAGES_FOLDER+data.slider_image+"' class='product-img product-img-vertical'/>";}
    },
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a class='btn btn-small btn-primary' href='../controller/edit_slider.php?id="+data.slider_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_slider.php?id="+data.slider_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5 class="text-truncate"><?php echo _SLIDERS; ?></h5>
        </div>
