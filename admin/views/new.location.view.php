                ...
                <div class="form-row">
                  <div class="form-group col-md-9">
                    <div class="block col-md-12">
                      ...
                      <input type="text" placeholder="" name="location_title" class="form-control" required="">

                      <label><?php echo _TABLEFIELDDESCRIPTION; ?></label>

                      <textarea type="text" class="mceNoEditor form-control" name="location_description"></textarea>

                   <label class="control-label"><?php echo _TABLEFIELDFEATURED; ?></label>
                   <select class="custom-select form-control" name="location_featured">
                     ...
                     <option value="1"><?php echo _YESTEXT; ?></option>
                      ...
                      <fieldset>
                        ...
                        <input type="text" name="location_seotitle" class="form-control">

                        <label><?php echo _SEODESCRIPTION; ?></label>
                        <textarea type="text" class="mceNoEditor form-control" name="location_seodescription"></textarea>
                  ...
                  <option value="0"><?php echo _DISABLED; ?></option>
                    ...
                    <div class="block col-md-12">
                      ...
                      <div class="new-image" id="image-preview">
                        ...
                        <input type="file" name="location_image" id="image-upload" required="" />
                      </div>
