...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     ...
     "iDisplayLength": 10,
     "aoColumns": [
     { mData: 'subcategory_id', "width": "5%", "className": "text-center"},
     { mData: 'subcategory_title', "width": "24%", "className": "text-center"},
     { mData: 'category_title', "width": "24%", "className": "text-center"},
