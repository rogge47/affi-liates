...
<script type="text/javascript">
  $(document).ready(function(){
    $('#table_id').dataTable({
     "bProcessing": true,
     "sAjaxSource": "../controller/get_locations.php",
     "responsive": true,
     "bPaginate":true,
     "sPaginationType":"full_numbers",
     "iDisplayLength": 10,
     "aoColumns": [
     { mData: 'location_id', "width": "5%", "className": "text-center" },
     { "mData": null , "width": "12%", "className": "product text-center",
     "mRender" : function (data) {
      return "<img src='"+IMAGES_FOLDER+data.location_image+"' class='product-img product-img-vertical'/>";}
    },
    { mData: 'location_title'},
    { "mData": null , "width": "10%", "className":"status text-center",
     "mRender" : function (data) {
      if (data.location_featured == 1) {
    ...
    'searchable': false,
    "mRender" : function (data) {
      return "<a class='btn btn-small btn-primary' href='../controller/edit_location.php?id="+data.location_id+"'>"+EDITITEM+"</a> <a class='btn btn-small btn-danger btn-delete deleteItem' data-url='../controller/delete_location.php?id="+data.location_id+"'>"+DELETEITEM+"</a>";}
    }
    ]
  });
  });
    ...
    <div class="content sm-gutter">
      <div class="container-fluid padding-25 sm-padding-10">
        ...
        <div class="section-title">
          <h5 class="text-truncate"><?php echo _LOCATIONS; ?></h5>
        </div>

        <div class="row">

          <div class="col-12 c-col-12">
            <a class="btn btn-primary" href="../controller/new_location.php">
